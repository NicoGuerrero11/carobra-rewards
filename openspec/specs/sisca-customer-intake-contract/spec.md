# SISCA Customer Intake Contract

## Purpose

Define the canonical MVP integration contract where Rewards owns customer
registration and SISCA provides only AFORE validation data.
...
- **WHEN** the `D5` check still returns `ACEPTADA OPERACIONES`
