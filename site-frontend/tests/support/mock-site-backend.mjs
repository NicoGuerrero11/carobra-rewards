...
const bronzeCoupons = [
  coupon("cinepolis", "Cinépolis", "2x1", "Entretenimiento", "Beneficio en entradas participantes."),
...
function coupon(id, name, discount, category, shortDescription) {
  return {
    id,
    name,
    discount,
    ...
    minimumLevel: "BRONZE",
    displayOrder: bronzeCouponOrder(id),
  };
}

function bronzeCouponOrder(id) {
  return ["cinepolis", "toks", "benavides", "smart-fit", "chopo"].indexOf(id) + 1;
}
